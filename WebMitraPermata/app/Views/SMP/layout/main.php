...
<head>
    ...
    <!-- Favicon -->
    <link href="<?= base_url('assets/smp/img/logo.png') ?>" rel="icon">
    ...
    <!-- Libraries Stylesheet -->
     <link href="<?= base_url('assets/smp/lib/animate/animate.min.css') ?>" rel="stylesheet">
     <link href="<?= base_url('assets/smp/lib/owlcarousel/assets/owl.carousel.min.css') ?>" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <!-- PINDAHKAN BUTTON KE DALAM NAVBAR-NAV -->
                    <a href="javascript:void(0)"  onclick="document.getElementById('brosurPopupSMP')
