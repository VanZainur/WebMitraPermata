...
<body>
   ...
   <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="navbar-nav ms-auto p-4 p-lg-0">
        <a href="<?= base_url('smk'); ?>" class="nav-item nav-link">Home</a>
        <a href="<?= base_url('smk/about'); ?>" class="nav-item nav-link">About</a>
        <a href="<?= base_url('smk/courses'); ?>" class="nav-item nav-link active">Courses</a>
            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="<?= base_url('assets/smk/img/cat-1.jpg'); ?>" alt="">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                            <a class="position-relative d-block overflow-hidden" href="">
                               <img class="img-fluid" src="<?= base_url('assets/smk/img/cat-2.jpg'); ?>" alt="">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                               <img class="img-fluid" src="<?= base_url('assets/smk/img/cat-3.jpg'); ?>" alt="">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('assets/smk/img/cat-4.jpg'); ?>" alt="">
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:  1px;">
