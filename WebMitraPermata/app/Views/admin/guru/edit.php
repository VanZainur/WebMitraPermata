...
<head>
    ...
    <title>Edit Guru - <?= strtoupper($jenjang ?? 'ADMIN') ?></title>
                ...
                <form action="<?= base_url('admin/guru/update/'.$guru['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenjang" class="form-control" required>
                            <option value="smk" <?= $guru['jenjang'] === 'smk' ? 'selected' : '' ?>>SMK</option>
                            <option value="smp" <?= $guru['jenjang'] === 'smp' ? 'selected' : '' ?>>SMP</option>
                            <option value="sd" <?= $guru['jenjang'] === 'sd' ? 'selected' : '' ?>>SD</option>
                            <option value="tk" <?= $guru['jenjang'] === 'tk' ? 'selected' : '' ?>>TK</option>
                        </select>
                    </div>
                    <?php else: ?>
                    <div class="form-group">
                        <label>Jenjang</label>
                        <input type="text" class="form-control" value="<?= strtoupper($guru['jenjang']) ?>" readonly>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jabatan" class="form-control" value="<?= esc($guru['jabatan']) ?>" required>
                        <span class="form-hint">Contoh: Kepala Sekolah, Guru Matematika</span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-image-container">
                            ...
                            <img src="<?= base_url('uploads/' . strtolower($guru['jenjang']) . '/guru/' . $guru['foto']) ?>" 
                                alt="Foto Saat Ini" 
                                class="current-image">
                        </div>
                        <?php endif; ?>
