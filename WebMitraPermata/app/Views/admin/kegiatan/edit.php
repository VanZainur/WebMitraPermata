...
<head>
    ...
    <title>Edit kegiatan - <?= strtoupper($jenjang ?? 'ADMIN') ?></title>
        ...
        <div class="content-area">
            ...
            <div class="form-container">
                <form action="<?= base_url('admin/kegiatan/update/'.$kegiatan['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Jenjang</label>
                        <input type="text" class="form-control" value="<?= strtoupper($kegiatan['jenjang']) ?>" readonly>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" required><?= esc($kegiatan['deskripsi']) ?></textarea>
                    </div>
