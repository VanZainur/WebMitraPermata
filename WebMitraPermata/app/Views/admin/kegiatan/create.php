...
<head>
    ...
    <title>Tambah kegiatan - <?= strtoupper($jenjang ?? 'ADMIN') ?></title>
            ...
            <div class="form-container">
                <form action="<?= base_url('admin/kegiatan/store') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Masukkan deskripsi kegiatan" required></textarea>
                    </div>
