    ...
    <main class="main-content">
        ...
        <div class="form-container">
          ...
          <!-- TAMPILKAN ERROR -->
                ...
                <div class="form-group">
                    <label>Judul</label>
                    <input type="text" name="judul" placeholder="Masukkan judul kegiatan" required>
                </div>

                <div class="form-group">
                    <label>Deskripsi</label>
                    <textarea name="deskripsi" placeholder="Masukkan deskripsi kegiatan" required></textarea>
                </div>
