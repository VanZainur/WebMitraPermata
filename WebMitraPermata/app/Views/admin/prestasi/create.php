...
<head>
    ...
    <title>Tambah prestasi - <?= strtoupper($jenjang ?? 'ADMIN') ?></title>
            ...
            <div class="form-container">
                <form action="<?= base_url('admin/prestasi/store') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul" class="form-control" placeholder="Masukkan judul prestasi" required>
                    </div>

                    <!-- DESKRIPSI -->
                    <div class="form-group">
                        <label>Deskripsi<span class="required">*</span></label>
                        <textarea name="deskripsi" class="form-control" placeholder="Masukkan deskripsi prestasi" required></textarea>
                    </div>
