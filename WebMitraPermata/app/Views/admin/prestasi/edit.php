    ...
    <main class="main-content">
        ...
        <div class="form-container">
            <form action="<?= base_url('admin/prestasi/update/'.$prestasi['id']) ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Jenjang</label>
                    <input type="text" value="<?= strtoupper($prestasi['jenjang']) ?>" readonly style="background:#f1f5f9; cursor:not-allowed;">
                </div>
                <?php endif; ?>

                <div class="form-group">
                    <label>Judul</label>
                    <input type="text" name="judul" value="<?= esc($prestasi['judul']) ?>" required>
                </div>

                <div class="form-group">
                    <label>Deskripsi</label>
                    <textarea name="deskripsi" required><?= esc($prestasi['deskripsi']) ?></textarea>
                </div>
                ...
                <div class="form-group">
                    <label>Tanggal</label>
                    <input type="date" name="tanggal" value="<?= $prestasi['tanggal'] ?>" required>
                </div>
