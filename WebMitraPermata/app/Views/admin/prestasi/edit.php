...
<head>
    ...
    <title>Edit prestasi - <?= strtoupper($jenjang ?? 'ADMIN') ?></title>
                ...
                <form action="<?= base_url('admin/prestasi/update/'.$prestasi['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenjang" class="form-control" required>
                            <option value="smk" <?= $prestasi['jenjang'] === 'smk' ? 'selected' : '' ?>>SMK</option>
                            <option value="smp" <?= $prestasi['jenjang'] === 'smp' ? 'selected' : '' ?>>SMP</option>
                            <option value="sd" <?= $prestasi['jenjang'] === 'sd' ? 'selected' : '' ?>>SD</option>
                            <option value="tk" <?= $prestasi['jenjang'] === 'tk' ? 'selected' : '' ?>>TK</option>
                        </select>
                    </div>
                    <?php else: ?>
                    <div class="form-group">
                        <label>Jenjang</label>
                        <input type="text" class="form-control" value="<?= strtoupper($prestasi['jenjang']) ?>" readonly>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul" class="form-control" value="<?= esc($prestasi['judul']) ?>" required>
                    </div>

                    <!-- DESKRIPSI -->
                    <div class="form-group">
                        <label>Deskripsi<span class="required">*</span></label>
                        <textarea name="deskripsi" class="form-control" required><?= esc($prestasi['deskripsi']) ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-image-container">
                            ...
                            <img src="<?= base_url('uploads/' . strtolower($prestasi['jenjang']) . '/prestasi/' . $prestasi['gambar']) ?>" 
                                alt="Gambar Saat Ini" 
                                class="current-image">
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?= base_url('admin/prestasi') ?>" class="btn btn-secondary">
                            <span>↩️</span>
                            <span>Batal</span>
                        </a>
                    </div>
